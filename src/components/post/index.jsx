...
const Post = ({ post }) => {
  return (
    <div className="px-4 py-3 gap-3 border-b border-[color:var(--background-third)] flex relative before:inset-0 before:absolute before:z-[-1] before:transition-colors before:opacity-50 before:hover:bg-[color:var(--background-secondary)]">
      <img
      ...
      <div className="flex-1">
        <header className="leading-5 flex items-center gap-2 mb-0.5">
          <a href="#" className="hover:underline flex items-center font-bold">
            ...
            {post.account?.verified && (
              <svg
                viewBox="0 0 22 22"
                className="text-[#1d9bf0] h-[1.172rem] ml-0.5"
              >
                <path
                  fill="currentColor"
        ...
        <div>
          ...
          <div className="flex -ml-1.5 mt-1.5">
            ...
            <div className="flex-1 group flex items-center gap-px">
              <div className="w-[2.172rem] h-[2.172rem] transition-colors flex items-center justify-center text-[color:var(--color-base-secondary)] group-hover:bg-[#A712581a] rounded-full group-hover:text-[#A71258]">
                <svg viewBox="0 0 24 24" className="h-[1.172rem]">
                  <path
                    fill="currentColor"
              ...
              <span className="text-[0.813rem] transition-colors text-[color:var(--color-base-secondary)] group-hover:text-[#A71258]">
